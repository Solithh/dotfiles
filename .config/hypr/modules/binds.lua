...
hl.bind(mainMod .. " + ALT + SHIFT + 1", hl.dsp.window.move({ workspace = 6 }))
hl.bind(mainMod .. " + ALT + SHIFT + 2", hl.dsp.window.move({ workspace = 7 }))
hl.bind(mainMod .. " + ALT + SHIFT + 3", hl.dsp.window.move({ workspace = 8 }))
hl.bind(mainMod .. " + ALT + SHIFT + 4", hl.dsp.window.move({ workspace = 9 }))
